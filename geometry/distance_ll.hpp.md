...
data:
  ...
  bundledCode: "#line 2 \"geometry/base.hpp\"\n\nnamespace geometry {\n  using Real\
    ...
    \ geometry\n"
  code: "#include \"distance_lp.hpp\"\n#include \"is_intersect_ll.hpp\"\n#include\
    \ \"line.hpp\"\n\nnamespace geometry {\n  Real distance_ll(const Line &l, const\
    \ Line &m) {\n    return is_intersect_ll(l, m) ? 0 : distance_lp(l, m.a);\n  }\n\
    } // namespace geometry\n"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: geometry/distance_ll.hpp
layout: document
redirect_from:
- /library/geometry/distance_ll.hpp
- /library/geometry/distance_ll.hpp.html
