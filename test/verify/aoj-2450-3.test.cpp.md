...
data:
  ...
  bundledCode: "#line 1 \"test/verify/aoj-2450-3.test.cpp\"\n#define PROBLEM \\\n\
    \  \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2450\"\n\n#line\
    \ 1 \"structure/develop/lazy-reversible-splay-tree.hpp\"\n/**\n * @brief Lazy-Reversible-Splay-Tree(\u9045\
    \u5EF6\u4F1D\u642C\u53CD\u8EE2\u53EF\u80FDSplay\u6728)\n */\ntemplate < typename\
    ...
    \ = [](const Node &a, int64 x) { return Node(x, a.length); };\n  auto H = [](int64,\
    \ int64 y) { return y; };\n  auto T = [](Node a) {\n    swap(a.left, a.right);\n\
